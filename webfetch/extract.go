...
// extractContent converts an HTTP response body into plain text suitable for
...
//
// Binary media types are rejected with an error.
func extractContent(contentType string, body []byte) (text string, isHTML bool, err error) {
...
// hasHiddenAttr reports whether a node carries an attribute that should hide
// it from the rendered output (HTML "hidden" attribute or inline
